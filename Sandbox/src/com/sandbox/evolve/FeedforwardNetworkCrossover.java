...
public class FeedforwardNetworkCrossover extends AbstractCrossover<FeedforwardNetwork> {
	...
	@Override
	protected List<FeedforwardNetwork> mate(final FeedforwardNetwork parent1, final FeedforwardNetwork parent2, final int numberOfCrossoverPoints, final Random rng) {
		if (!parent1.getLayout().equals(parent2.getLayout()))
			throw new IllegalArgumentException("Cannot perform crossover with incompatible parents.");
